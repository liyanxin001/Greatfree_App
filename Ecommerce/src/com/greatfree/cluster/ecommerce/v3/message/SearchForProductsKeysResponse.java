...
public class SearchForProductsKeysResponse extends MulticastResponse{
	
	private static final long serialVersionUID = 8164720014059462909L;
	private List<String> productKeys;
	

	public SearchForProductsKeysResponse(List<String> productKeys,  String collaboratorKey) {
