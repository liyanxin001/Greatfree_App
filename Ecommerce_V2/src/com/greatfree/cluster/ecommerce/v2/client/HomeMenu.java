...
public final class HomeMenu {
	...
	public final static String SEARCH_FOR_PRODUCTS = TAB + "1)Search for products";
	public final static String CREATE_STORE = TAB + "2)Create your store:";
	public final static String GO_TO_STORE= TAB + "3)Go to your store:";
